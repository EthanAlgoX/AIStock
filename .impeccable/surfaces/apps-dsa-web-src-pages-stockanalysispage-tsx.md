...
FIRST VIEWPORT: stock masthead and price snapshot, chapter links, thesis, compact boundary margin on wide screens; mobile stacks and exposes recorded-limitations link.
