...
想先體驗？推薦直接使用已上線的 AI Stock 網站。**申請邀請碼後註冊登入即可使用，無需下載或自行部署。**
...
| 研究加密貨幣現貨 | 市場雷達、個股研究、策略選股、交易推演及持倉管理 | USDT 現貨行情、選幣、小時線規則回測及模擬持倉 |
...
在各模組內切換至「加密貨幣」，即可使用 24/7 Binance 現貨模擬；不會向交易所下單。詳見[現貨說明（英文）](crypto-spot_EN.md)。
