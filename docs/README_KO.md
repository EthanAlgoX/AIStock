...
| 암호화폐 현물 살펴보기 | 암호화폐 작업 공간 | USDT 현물 시세, 코인 선별, 시간봉 규칙 백테스트 |
...
암호화폐는 연중무휴 Binance 현물 시장을 별도 화면에서 시뮬레이션하며 거래소에 실거래 주문을 보내지 않습니다. [현물 가이드(영어)](crypto-spot_EN.md)를 참고하세요.
