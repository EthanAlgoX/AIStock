...
![질문에서 데이터 수집, AI 분석과 결과 저장까지의 흐름](assets/readme/how-it-works-ko.svg)
...
이미 이용할 수 있는 사이트가 있다면 해당 사이트를 열고 [첫 보고서 만들기](#첫-보고서-만들기)로 이동하세요. 직접 실행하려면 아래 단계를 따르세요.
...
![첫 사용 4단계: 모델 연결, 기능 확인, 종목 입력, 보고서 확인](assets/readme/first-report-ko.svg)
