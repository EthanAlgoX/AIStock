...
| 암호화폐 현물 살펴보기 | 시장 레이더, 종목 리서치, 선별, 거래 시뮬레이션, 포트폴리오 | USDT 현물 시세, 코인 선별, 시간봉 규칙 백테스트, 모의 보유 |
...
각 기능에서 **암호화폐**로 전환하면 연중무휴 Binance 현물 시뮬레이션을 이용할 수 있습니다. 거래소에 실거래 주문을 보내지 않습니다. [현물 가이드(영어)](crypto-spot_EN.md)를 참고하세요.
