...
![質問からデータ収集、AI分析、結果の保存までの流れ](assets/readme/how-it-works-ja.svg)
...
すでに利用できるサイトがある場合は、そのサイトを開いて[最初のレポートを作る](#最初のレポートを作る)へ進んでください。自分の環境で動かす場合は、以下の手順で準備します。
...
![初回の4ステップ：モデル接続、機能確認、銘柄入力、レポート確認](assets/readme/first-report-ja.svg)
