...
**JEV APIキーの取得：** [JEV公式紹介とアクセス案内](https://typesafe.ai/blog/introducing-system-one-models-and-jev)を確認し、[TypeSafeコンソール](https://console.typesafe.ai/)にログインしてAPIキーを取得してください。アクセス申請やウェイトリストが必要な場合は、公式ページの案内に従ってください。JEVは独自のTypeSafe認証情報とSystem One APIを使用するため、サイトのJEV専用設定に入力します。
