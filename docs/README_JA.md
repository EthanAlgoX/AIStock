...
まずは公開中のAI Stockサイトをお試しください。**招待コードで登録し、ログインすれば利用できます。ダウンロードや自分でのサーバー構築は不要です。**
...
| 暗号資産の現物を調べる | 市場レーダー、個別銘柄リサーチ、選定、取引シミュレーション、保有管理 | USDT建て相場、通貨選定、時間足ルールのバックテスト、模擬保有 |
...
各機能で**暗号資産**に切り替えると、24時間365日動くBinance現物市場のシミュレーションを利用できます。取引所への実注文は行いません。[現物ガイド（英語）](crypto-spot_EN.md)をご覧ください。
