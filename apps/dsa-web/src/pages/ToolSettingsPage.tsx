  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-3 rounded-[12px] border border-warning/25 bg-warning/5 px-4 py-3 text-sm leading-6 text-secondary-text">
        ...
        <p><span className="font-medium text-warning">运行边界。</span> 下列站内工具已通过网站的金融 MCP Endpoint 发布给外部 Runtime；Nanobot 仍需在自身配置中连接该 Endpoint。工作区白名单会同时限制站内 Agent 和 MCP 暴露面。</p>
      </div>
