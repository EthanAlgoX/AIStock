...
const NotFoundPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-4">
      ...
      <h1 className="text-2xl font-bold text-foreground mb-2"><UiLiteral text={"页面未找到"} /></h1>
      <p className="text-muted-text mb-8"><UiLiteral text={"抱歉，您访问的页面不存在或已被移动"} /></p>
