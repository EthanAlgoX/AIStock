...
export type WorkspaceTask = { id:string; kind:WorkspaceTaskKind; name:string; market:"CN"|"HK"|"US"|"TW"|"JP"|"KR"|"GB"|"CA"|"AU"|"IN"|"DE"|"FR"|"CRYPTO"|"GLOBAL"; objective:string; subject:Record<string,unknown>; config:Record<string,unknown>; capabilities:AgentCapabilityBindings; version:number; enabled:boolean; createdAt:string; updatedAt:string };
