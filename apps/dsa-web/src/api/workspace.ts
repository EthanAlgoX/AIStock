...
export const workspaceApi = {
  ...
  async createSchedule(payload:{taskId:string;name:string;scheduleMode:"daily"|"interval";runAt?:string;intervalMinutes?:number;timezone:string;enabled?:boolean;publishToMarket?:boolean;marketDashboardTitle?:string}) { const { data } = await apiClient.post<WorkspaceSchedule>(`${root}/schedules`,payload); return data; },
