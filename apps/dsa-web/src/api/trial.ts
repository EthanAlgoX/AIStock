...
export const trialApi = {
  ...
  async run(body: { requestId: string; kind: TrialKind; topic: string; stock: string; language: 'en' | 'zh' | 'ko' | 'ja' | 'zh-TW'; experts: string[]; mode: 'independent' | 'debate' }) { return (await api.post<{ id: string }>(root + '/runs', body)).data; },
