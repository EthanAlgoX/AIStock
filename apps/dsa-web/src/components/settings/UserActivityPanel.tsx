...
type Call = { fundingSource?: string; id: string; userId: string; requestId: string; date: string; feature: string; model: string | null; charged: number; estimated: boolean; promptTokens: number | null; completionTokens: number | null; durationMs: number | null; error: string | null };
