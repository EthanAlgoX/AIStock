...
// Keep the current strategy platform self-contained. The inherited Daily
// Stock documentation describes a different product flow and must not be
// presented as authoritative settings help here.
const LLM_CHANNEL_HELP_DOCS: Array<{ label: string; href: string }> = [];
