...
export default function WorkflowArtifact({ artifact, researchPresentation }: { artifact: Artifact; researchPresentation?: "memo" }) {
  ...
  const holdingRecommendation = object(envelope.holdingRecommendation);
