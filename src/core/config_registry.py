...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TYPESAFE_API_KEY": {
        'title': 'JEV API Key',
        'description': 'TypeSafe API credential for trading decisions only. Does not generate reports.',
        'category': 'ai_model',
        'data_type': 'string',
        'ui_control': 'password',
        'is_sensitive': True,
    ...
    "TYPESAFE_BASE_URL": {
        ...
        'description': 'TypeSafe System One service base URL. HTTPS required.',
        'category': 'ai_model',
        'data_type': 'string',
        'ui_control': 'text',
        'is_sensitive': False,
    ...
    "TYPESAFE_MODEL": {
        'title': 'JEV Model',
        'description': 'Model name or fixed version used for new trading strategies.',
        'category': 'ai_model',
        'data_type': 'string',
        'ui_control': 'text',
        'is_sensitive': False,
    ...
    "FRED_API_KEY": {
        "title": "FRED API Key",
        "description": "Free API key for official Federal Reserve Economic Data macro series.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "validation": {},
        "display_order": 11,
        "help_key": "settings.data_source.FRED_API_KEY",
        "examples": ["FRED_API_KEY=your_fred_api_key"],
        "docs": [{"label": "FRED API Key 申请", "href": "https://fred.stlouisfed.org/docs/api/api_key.html"}],
        "warning_codes": ["secret_value"],
    },
    "JQUANTS_API_KEY": {'title': 'J-Quants API Key',
     'description': 'J-Quants V2 official Japanese daily prices. The Free plan is delayed by 12 '
                    'weeks.',
     'category': 'data_source',
     'data_type': 'string',
     'ui_control': 'password',
     ...
     'validation': {},
     'display_order': 12,
     'help_key': 'settings.data_source.JQUANTS_API_KEY',
     'examples': ['JQUANTS_API_KEY=your_api_key'],
     'docs': [{'label': 'J-Quants API Key', 'href': 'https://jpx-jquants.com/en'}],
     'warning_codes': ['secret_value']},
    "KRX_API_KEY": {'title': 'KRX API Key',
     'description': 'KRX 官方日线行情；需要 API 审批及数据使用授权。',
     'category': 'data_source',
     'data_type': 'string',
     'ui_control': 'password',
     'is_sensitive': True,
     ...
     'validation': {},
     'display_order': 12,
     'help_key': 'settings.data_source.KRX_API_KEY',
     'examples': ['KRX_API_KEY=your_api_key'],
     'docs': [{'label': 'KRX API Key', 'href': 'https://openapi.krx.co.kr/'}],
     'warning_codes': ['secret_value']},
    "HITHINK_FINANCE_API_KEY": {
        "title": "HiThink Financial API Key",
        "description": "API key for the official HiThink A-share quote, daily K-line, and index service. Failures fall back to existing providers.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "examples": ["HITHINK_FINANCE_API_KEY=your_api_key"],
        "docs": [{"label": "Financial API 官方文档", "href": "https://github.com/HiThink-Tech/Financial-API"}],
        "warning_codes": ["secret_value"],
    },
    "HITHINK_FINANCE_BASE_URL": {
        "title": "HiThink Financial API Base URL",
        "description": "REST base URL for HiThink Financial API. Keep the official endpoint unless using an explicitly trusted compatible gateway.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "https://fuyao.aicubes.cn",
        "options": [],
        "validation": {"item_type": "url", "allowed_schemes": ["http", "https"]},
        "display_order": 13,
        "help_key": "settings.data_source.HITHINK_FINANCE_BASE_URL",
        "examples": ["HITHINK_FINANCE_BASE_URL=https://fuyao.aicubes.cn"],
        "docs": [{"label": "Financial API REST 文档", "href": "https://github.com/HiThink-Tech/Financial-API/blob/main/docs/api/README.md"}],
    },
    "HITHINK_FINANCE_TIMEOUT_SECONDS": {
        "title": "HiThink Financial API Timeout",
        "description": "Per-request timeout in seconds. Timeout and server failures use bounded retry before provider fallback.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 14,
        "help_key": "settings.data_source.HITHINK_FINANCE_TIMEOUT_SECONDS",
        "examples": ["HITHINK_FINANCE_TIMEOUT_SECONDS=15"],
        "docs": [{"label": "Financial API REST 文档", "href": "https://github.com/HiThink-Tech/Financial-API/blob/main/docs/api/README.md"}],
    },
    "HITHINK_FINANCE_PRIORITY": {
        "title": "HiThink Financial API Priority",
        "description": "Position in the A-share daily K-line fallback chain. Lower numbers are tried earlier.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 15,
        "help_key": "settings.data_source.HITHINK_FINANCE_PRIORITY",
        "examples": ["HITHINK_FINANCE_PRIORITY=0"],
        "docs": [{"label": "Financial API REST 文档", "href": "https://github.com/HiThink-Tech/Financial-API/blob/main/docs/api/README.md"}],
    },
    "TICKFLOW_API_KEY": {
    ...
    "SCREENING_ENABLED": {
        ...
        "description": "Enable DSA's built-in stock screening tab. The implementation is based on AlphaSift and maintained as part of DSA. Enabled by default.",
        "category": "base",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "REPORT_LANGUAGE": {
        ...
        "validation": {"enum": ["zh", "en", "ko", "ja", "zh-TW"]},
        "display_order": 56,
        "help_key": "settings.notification.report_output",
        "examples": [
            "REPORT_LANGUAGE=zh",
    ...
    "MARKET_REVIEW_REGION": {
        ...
        "description": "Market region: cn, hk, us, jp, kr, tw, gb, ca, au, in, de, fr. Comma-separated subsets supported; both retains cn,hk,us,jp,kr.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "is_editable": True,
        "default_value": "cn",
        "options": ["cn", "hk", "us", "jp", "kr", "tw", "gb", "ca", "au", "in", "de", "fr", "both"],
        "validation": {"allowed_values": ["cn", "hk", "us", "jp", "kr", "tw", "gb", "ca", "au", "in", "de", "fr", "both"], "delimiter": ","},
        "display_order": 48,
        "help_key": "settings.system.market_review",
        "examples": [
            "MARKET_REVIEW_REGION=cn",
