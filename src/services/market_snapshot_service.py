...
def _serialize_snapshot(
    region: str, overview: MarketOverview, *,
    analysis_skills: list[str], turnover_unit: str = "",
) -> Dict[str, Any]:
    ...
    payload: Dict[str, Any] = {
        ...
        "region": region,
        "market_scope": _REGION_LABELS[region],
...
def get_current_market_snapshot(
    ...
    *,
    ...
    if normalized_region not in _SUPPORTED_REGIONS:
        raise ValueError(f"Unsupported snapshot region: {region}")
    ...
    snapshot = _serialize_snapshot(
        normalized_region, analyzer.get_market_overview(),
