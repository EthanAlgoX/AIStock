...
_BUILTIN_SOURCE_TEMPLATES = [
    ...
    {
        "template_id": "global-cnbc-markets",
        "name": "CNBC Markets",
        "source_type": "rss",
        "url": "https://www.cnbc.com/id/100003114/device/rss/rss.html",
        "scope_type": "market",
        "market": "global",
        "description": "CNBC public RSS for global equities, macro and company-event context.",
    },
    {
        "template_id": "global-yahoo-finance",
        "name": "Yahoo Finance News",
        "source_type": "rss",
        "url": "https://finance.yahoo.com/news/rssindex",
        "scope_type": "market",
        "market": "global",
        "description": "Yahoo Finance public RSS for global market and company-news context.",
    },
    {
        "template_id": "global-financial-times",
        "name": "Financial Times",
        "source_type": "rss",
        "url": "https://www.ft.com/rss/home",
        "scope_type": "market",
        "market": "global",
        "description": "Financial Times public RSS for global macro, markets and corporate context.",
    },
    {
        "template_id": "global-reuters-business",
        "name": "Reuters Business",
        "source_type": "rss",
        "url": "https://news.google.com/rss/search?q=site%3Areuters.com%20business%20markets%20when%3A1d&hl=en-US&gl=US&ceid=US%3Aen",
        "scope_type": "market",
        "market": "global",
        "description": "Google News RSS query restricted to Reuters business and markets coverage.",
    },
    {
        "template_id": "global-business-wire",
        "name": "Business Wire",
        "source_type": "rss",
        "url": "https://feed.businesswire.com/rss/home/?rss=G1QFDERJXkJeGVtRWA==",
        "scope_type": "market",
        "market": "global",
        "description": "Business Wire public RSS for company announcements and corporate events.",
    },
    {
        "template_id": "global-globenewswire",
        "name": "GlobeNewswire",
        "source_type": "rss",
        "url": "https://www.globenewswire.com/RssFeed/subjectcode/22/feedTitle/GlobeNewswire",
        "scope_type": "market",
        "market": "global",
        "description": "GlobeNewswire public RSS for company announcements and corporate events.",
    },
    {
        "template_id": "us-federal-reserve",
        "name": "Federal Reserve Press Releases",
        "source_type": "rss",
        "url": "https://www.federalreserve.gov/feeds/press_all.xml",
        "scope_type": "market",
        "market": "us",
        "description": "Federal Reserve official RSS for monetary-policy and market-impact evidence.",
    },
]
...
class IntelligenceService:
    ...
    def __init__(
        ...
        # Tests and embedders can isolate one service instance without replacing
        # the process-global requests module.  Production keeps the normal
        # dynamically resolved requests.get behavior.
    ...
    def _get_with_validated_dns(self, raw_url: str, **kwargs: Any) -> requests.Response:
        ...
        with _DNS_GUARD_LOCK:
            ...
            try:
                ...
                return getter(raw_url, **request_kwargs)
            finally:
