...
DEMO_STOCKS = {"CN": "600519", "HK": "HK00700", "US": "AAPL", "TW": "2330.TW", "JP": "7203.T", "KR": "005930.KS", "GB": "HSBA.L", "CA": "RY.TO", "AU": "BHP.AX", "IN": "RELIANCE.NS", "DE": "SAP.DE", "FR": "AIR.PA", "CRYPTO": "BTCUSDT"}
    ...
    if kind in {"research", "screening"}:
        ...
        for item in definitions.list_strategies():
            ...
            if kind == "research":
                ...
                rank = {"crypto_liquidity": 0, "international_momentum": 0, "balanced_alpha": 0, "quality_value": 1, "dual_low": 2}.get(rule, 9)
            if rank < 9:
