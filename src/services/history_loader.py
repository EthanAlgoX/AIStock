...
def load_history_df(
    ...
    connection: str = "system_market_data",
    ...
    use_cached_any_source = connection in {"system_market_data", "local_stock_daily", ""}
    ...
    try:
        ...
        cache_is_current = connection == "local_stock_daily" or latest_date >= end
        if use_cached_any_source and bars and cache_is_current and len(bars) >= required_records:
    ...
    if connection == "local_stock_daily":
        return None, "none"
