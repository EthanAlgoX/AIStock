...
class AnalyzeRequest(BaseModel):
    ...
    report_language: Optional[Literal["zh", "en", "ko", "ja", "zh-TW"]] = Field(
        None,
    ...
    strategy_version_id: Optional[int] = Field(
        None,
        ge=1,
        validation_alias=AliasChoices("strategy_version_id", "strategyVersionId"),
        description="策略中心正式发布的完整单股研究策略版本",
    )
...
class AnalysisResultResponse(BaseModel):
    ...
    strategy_version_id: Optional[int] = Field(None, description="实际调用的完整策略版本")
